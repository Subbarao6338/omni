...
# Comprehensive mapping of routes to specific hubs
route_to_hub = {
    # System Monitor
    ...
    "altitude_graph", "altitude_graph": "Outdoor & Adventure", "area_calc": "Outdoor & Adventure",
    ...
    if 'Tool(' in line:
        ...
        if route_match:
            ...
            if route in route_to_hub:
                ...
                # Replace category
                # Line format: Tool(name, icon, route, category, ...)
                parts = line.split(',')
                # category is parts[3]
                parts[3] = f' "{new_hub}"'
                line = ','.join(parts)
